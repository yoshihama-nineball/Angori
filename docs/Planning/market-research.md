...
**推奨戦略**: 意外性マーケティングによる認知獲得 → ゴリラの親しみやすさで継続利用促進
...
#### 感情の可視化・分析
- 感情メモ（出来事・感情の種類と強さ・考えたこと・状況の整理）を記録できる →アンガーログで相談した内容を振り返ることができる
...
#### Calm（カーム）
**強み**:
- Calmは睡眠導入用のストーリーテリング機能や自然音を利用したプログラムで人気がある
- 2020年には1億ダウンロードを突破し、世界中の人のストレス・不安感・不眠などストレスが原因で現れる諸症状の緩和に貢献してきた
...
#### Headspace（ヘッドスペース）
**強み**:
- Headspaceは、短い時間でも効果的に実践できるような「ミニセッション」を提供している
- アプリを開くと、オレンジを基調とし、かわいいアニメーションに驚かされる。洗練され落ち着いたデザインのCalmとは違い、かなりポップな印象
